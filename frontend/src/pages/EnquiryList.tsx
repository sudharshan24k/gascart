                                ...
                                <div className="flex-grow">
                                    ...
                                    <div className="flex items-center justify-between mt-6">
                                        ...
                                        <div className="text-right">
                                            ...
                                            <span className="font-black text-2xl text-gray-900">₹{(item.price * item.quantity).toLocaleString('en-IN')}</span>
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
                        ...
                        <div className="bg-white p-10 rounded-[40px] shadow-xl border border-gray-100 sticky top-32">
                            ...
                            <div className="space-y-6 mb-10">
                                ...
                                <div className="pt-6 border-t border-gray-50 flex justify-between items-center">
                                    ...
                                    <span className="font-black text-3xl text-primary">₹{state.total.toLocaleString('en-IN')}</span>
                                </div>
                            </div>
