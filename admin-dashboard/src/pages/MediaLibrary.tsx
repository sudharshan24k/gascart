...
import {
    ...
    Folder, RefreshCw, X, AlertCircle, Eye, ExternalLink
} from 'lucide-react';
...
const MediaLibrary: React.FC = () => {
    ...
    const loadFiles = async () => {
        ...
        try {
            ...
            setError(err.message || 'Failed to load files. Check if this bucket exists in Supabase.');
        } finally {
            setLoading(false);
        }
    };
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                                    ...
                                    <button
                                        ...
                                        className="p-2 bg-red-500 rounded-xl shadow"
                                        title="Delete"
                                    >
                ...
                >
                    ...
                    >
                        <div className="p-6 border-b border-gray-100 flex items-center justify-between">
                            <div>
                                <h3 className="font-black text-gray-900 text-lg truncate max-w-sm">{previewFile.name}</h3>
                                <p className="text-xs text-gray-400 font-medium mt-0.5">{formatSize(previewFile.size)} · {currentBucket.label}</p>
                            </div>
                            <button onClick={() => setPreviewFile(null)} className="p-2 rounded-xl hover:bg-gray-100 transition">
